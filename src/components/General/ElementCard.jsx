...
const ElementCard = ({ id,img, sale, name, price, beforePrice, link }) => {
    ...
    <div className="bg-[#f5f5f5] rounded-[8px] overflow-hidden max-w-[330px]">
      ...
      <div className="p-[16px] flex flex-col items-start gap-[16px]">
        ...
        <div className="flex items-center justify-between w-full">
          <button onClick={addToCard} className="flex items-center gap-[10px] bg-[#FFD23F] py-[16px] px-[30px] rounded-[32px]">
