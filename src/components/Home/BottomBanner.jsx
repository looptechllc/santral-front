  ...
  return (
    <div className="md:w-[95%] mx-auto px-3 my-[60px] flex flex-col md:flex-row  gap-[24px]">
      ...
      <div className="  w-full  rounded-[16px] overflow-hidden  relative">
        ...
        <Link to="/az/schneider-electric-273/" className="absolute  top-[24px] left-[24px] bg-[#000]/50 text-white duration-300 hover:bg-[#FFD23F]/80 hover:text-black rounded-[8px] px-[16px] py-[12px] ">
          {" "}
      ...
      <div className="rounded-[16px] overflow-hidden w-full relative">
        ...
        <Link to="/az/bosch-altlr-37/" className="absolute  top-[24px] left-[24px] bg-[#000]/50 text-white duration-300 hover:bg-[#FFD23F]/80 hover:text-black rounded-[8px] px-[16px] py-[12px] ">
          {" "}
      ...
      <div className="rounded-[16px] overflow-hidden   relative">
        ...
        <Link to="/az/gardena-212/" className="absolute  top-[24px] left-[24px] right-[24px] bg-[#000]/50 text-white duration-300 hover:bg-[#FFD23F]/80 hover:text-black rounded-[8px] px-[16px] py-[12px] ">
          {" "}
